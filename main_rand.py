...
# np.random.seed(67)
# x = np.random.uniform(low=10, high=100, size=muestras)
# ruido = np.random.normal(loc=0.0, scale=ruido_scale, size=muestras)
...
# theta0 := theta0 +- alpha / m SUM(h(theta0)xi - y)x
