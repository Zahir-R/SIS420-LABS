...
ejemplo_n = np.insert(X_df.iloc[50].values, 0, 1)
...
pyplot.plot(y[:200], color='black', lw=2)
pyplot.plot(y_pred_dg[:200], lw=2)
pyplot.plot(y_pred_n[:200], color='red', lw=2)
