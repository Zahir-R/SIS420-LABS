...
# %% id="SqAvfVjliMIa" executionInfo={"status": "ok", "timestamp": 1787841085352, "user_tz": 240, "elapsed": 3546, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
import torch
...
# %% hidden=true id="o_ERwwGkiMIf" outputId="3c0d51c1-555a-44f4-f935-90a8308b793e" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991506, "user_tz": 240, "elapsed": 103, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
import numpy as np
...
# %% hidden=true id="lcbVUMRdiMIg" outputId="7150820a-7294-41f0-a927-ad4c80d5327b" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991530, "user_tz": 240, "elapsed": 23, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# tensor con valores aleatorios

x = torch.randn(5, 3, 2)
x

# %% hidden=true id="ULZfDNL0iMIg" outputId="0ea5dbc5-6170-43d4-e8f1-7369203998ed" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991662, "user_tz": 240, "elapsed": 132, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# tensor a partir de lista

x = torch.tensor([[1, 2, 3],[4, 5, 6]])
x

# %% hidden=true id="-hBxpgUIiMIh" outputId="f9e3b07a-8ec2-4f5c-a4cc-57507d948c14" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991677, "user_tz": 240, "elapsed": 14, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
import numpy as np
...
# %% hidden=true id="GmxyiVMMiMIh" outputId="71172581-c4b2-46eb-ac41-152e108a63b8" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991703, "user_tz": 240, "elapsed": 20, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# operaciones
...
# %% hidden=true id="gn1z1FOviMIi" outputId="dec33a9e-ed17-44cf-d50a-d8f4b13bbf54" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991815, "user_tz": 240, "elapsed": 111, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
x + y

# %% hidden=true id="CqMY2660iMIi" outputId="f8ca0101-5c4a-48f2-dc36-41f238abbb18" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991835, "user_tz": 240, "elapsed": 33, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
x - y

# %% hidden=true id="pjYd-XwiiMIi" outputId="48ecebe7-5bd5-4215-e500-240080460cfa" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991847, "user_tz": 240, "elapsed": 22, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# indexado
...
# %% hidden=true id="dYGdMkDmiMIj" outputId="319e271a-00ec-43ff-b564-1b105224ed64" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991848, "user_tz": 240, "elapsed": 18, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# primera fila, primera columna

x[0, 0]

# %% hidden=true id="Me8oHUGaiMIj" outputId="9888febc-c3fd-4896-e6f0-4d0af7abc044" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991868, "user_tz": 240, "elapsed": 20, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# primera columna

x[0, :]

# %% hidden=true id="fw3GdsJ-iMIj" outputId="5fe26a4d-2a77-4ca0-9ba1-212af77dd732" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991868, "user_tz": 240, "elapsed": 6, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# troceado
...
# %% hidden=true id="ovWsFTZYiMIk" outputId="05b50501-934a-4064-f8b0-0307795760fb" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991872, "user_tz": 240, "elapsed": 5, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
x.shape

# %% hidden=true id="aVXMJ_pwiMIk" outputId="75814d54-7b57-461b-88e6-653f7a32ede0" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991884, "user_tz": 240, "elapsed": 12, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# añadimos una dimensión extra

x.view(1, 3, 3).shape

# %% colab={"base_uri": "https://localhost:8080/"} id="LDHzJl0rSmyb" executionInfo={"status": "ok", "timestamp": 1787840991928, "user_tz": 240, "elapsed": 43, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="a1f7b251-fab1-4dbd-bf3d-979cecb531b5"
x

# %% hidden=true id="IBFSHcL0iMIk" executionInfo={"status": "ok", "timestamp": 1787840991929, "user_tz": 240, "elapsed": 26, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# estiramos en una sola dimensión

# a = x.view(9).shape
a = x.view(9)

# %% colab={"base_uri": "https://localhost:8080/"} id="GcEVwOqMSxg7" executionInfo={"status": "ok", "timestamp": 1787840991930, "user_tz": 240, "elapsed": 26, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="4604227e-97e1-47da-d9d8-ed04d763eb63"
a

# %% hidden=true id="YoO2CeSjiMIl" executionInfo={"status": "ok", "timestamp": 1787840991939, "user_tz": 240, "elapsed": 13, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# usamos -1 para asignar todos los valores restantes a una dimensión

# b = x.view(2, 2, -1)

# %% id="ym4NzOf7S2vx" executionInfo={"status": "ok", "timestamp": 1787840991940, "user_tz": 240, "elapsed": 13, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}

# %% [markdown] hidden=true id="90DuaFxNiMIl"
# Podemos transformar un `tensor` en un `array` con la función `numpy`.

# %% hidden=true id="dKtMQ6t-iMIl" outputId="4be7258e-c34b-4811-8316-1690ebcb4ad1" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840991945, "user_tz": 240, "elapsed": 4, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
x.numpy()
...
# %% hidden=true id="63iykJNuiMIm" executionInfo={"status": "ok", "timestamp": 1787840991968, "user_tz": 240, "elapsed": 9, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
...
# %% hidden=true id="YtSCg3BZiMIm" executionInfo={"status": "ok", "timestamp": 1787840991979, "user_tz": 240, "elapsed": 12, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
g.backward()
...
# %% hidden=true id="OTYZAqWViMIn" outputId="515356c7-150f-42ac-dab2-18ef4c5fb03f" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840992007, "user_tz": 240, "elapsed": 19, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
z.grad

# %% [markdown] hidden=true id="EMoUWf8ZiMIn"
# $$ \frac{dg}{dx} = \frac{dg}{dp} \frac{dp}{dx} = z $$

# %% hidden=true id="BSY3Sm7ViMIn" outputId="f07ea507-2fb2-4064-c35b-8dcc4156264d" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840992011, "user_tz": 240, "elapsed": 9, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
x.grad

# %% [markdown] hidden=true id="GDlvvVJ8iMIn"
# $$ \frac{dg}{dy} = \frac{dg}{dp} \frac{dp}{dy} = z $$

# %% hidden=true id="ByIg6BDyiMIo" outputId="31318b80-ea66-4e2a-d5b9-897935503e23" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787840992012, "user_tz": 240, "elapsed": 6, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
y.grad
...
# %% hidden=true id="H1ptakV7iMIp" outputId="88f0fab3-1308-40a1-fe20-79b945d800d4" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787841161090, "user_tz": 240, "elapsed": 7250, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
import torch
# comprobar que podemos usar GPU

torch.cuda.is_available()

# %% hidden=true id="-ZsMuw1_iMIp" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787841356231, "user_tz": 240, "elapsed": 235, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="dfeff835-e2a4-46c8-bc03-25dfd8469ca9"
x = torch.randn(10000,1000)
y = torch.randn(10000,1000)

# %time z = x*y

# %% hidden=true id="jKPXsZhOiMIp" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787841381491, "user_tz": 240, "elapsed": 695, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="3cfccc05-5182-4d3f-badd-a541f1c6027b"
...
# %% hidden=true id="zLn-rSj3iMIp" executionInfo={"status": "ok", "timestamp": 1787840993299, "user_tz": 240, "elapsed": 34, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
...
# %% hidden=true id="mh_R_4HmiMIq" executionInfo={"status": "ok", "timestamp": 1787840993312, "user_tz": 240, "elapsed": 12, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
...
# %% hidden=true id="ROqo-XYsiMIq" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787841012862, "user_tz": 240, "elapsed": 19542, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="1b41507d-f25e-447f-8a3a-73057ba54bef"
...
# %% id="igRXPUCVaK2X" executionInfo={"status": "ok", "timestamp": 1787841012864, "user_tz": 240, "elapsed": 1, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
X = X.to_numpy()
Y = Y.to_numpy()

# %% id="VTTpb00jbHXa" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787841012869, "user_tz": 240, "elapsed": 4, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="2c15da22-5faf-41bd-80a2-68d1308681ab"
print(X.shape)

# %% id="WQxYz8E-cyFW" executionInfo={"status": "ok", "timestamp": 1787841012871, "user_tz": 240, "elapsed": 1, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# %matplotlib inline
...
# %% hidden=true id="KLQO5Kt1iMIq" colab={"base_uri": "https://localhost:8080/", "height": 608} executionInfo={"status": "ok", "timestamp": 1787841013465, "user_tz": 240, "elapsed": 594, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="b2d57acb-e1b4-44aa-e9d6-c4d3d1f19ac9"
r, c = 3, 5
...
# %% hidden=true id="KWuWJNmdiMIq" executionInfo={"status": "ok", "timestamp": 1787841013591, "user_tz": 240, "elapsed": 125, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
# normalizamos los datos

X_train, X_test, y_train, y_test = X[:60000] / 255., X[60000:] / 255., Y[:60000].astype(np.int64), Y[60000:].astype(np.int64)


# %% hidden=true id="XikttOaCiMIr" executionInfo={"status": "ok", "timestamp": 1787841013594, "user_tz": 240, "elapsed": 1, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
...
# %% code_folding=[21, 35] hidden=true id="P1gyCb2_iMIr" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787841015350, "user_tz": 240, "elapsed": 1754, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="c28446fd-4542-4679-f465-6ed20f0cca30"
...
# %% hidden=true id="XbNp1vWSiMIr" executionInfo={"status": "ok", "timestamp": 1787841015352, "user_tz": 240, "elapsed": 1, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}}
def evaluate(x):
    h = x.mm(w1) + b1
...
# %% hidden=true id="T_5ix9cOiMIr" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1787841015503, "user_tz": 240, "elapsed": 150, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="064aaa82-6162-440e-8196-a41935066071"
from sklearn.metrics import accuracy_score

y_pred = evaluate(torch.from_numpy(X_test).float().cuda())
accuracy_score(y_test, y_pred.cpu().numpy())

# %% hidden=true id="j7z67UleiMIr" colab={"base_uri": "https://localhost:8080/", "height": 663} executionInfo={"status": "ok", "timestamp": 1787841016323, "user_tz": 240, "elapsed": 807, "user": {"displayName": "Carlos Walter Pacheco Lora", "userId": "05889892519883337793"}} outputId="affb0b5b-21eb-4952-85f9-23db789d7208"
r, c = 3, 5
fig = plt.figure(figsize=(2*c, 2*r))
test_imgs, test_labs = [], []
for _r in range(r):
